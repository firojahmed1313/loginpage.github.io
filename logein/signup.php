<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] =="POST")
    {
        ...
        //$exists=false;
        $existSql="Select * FROM id_test WHERE email='$email'";
        ...
        if ($numExist>0) {
            ...
            if (($password==$Cpassword)) {
                ...
                $sql="INSERT INTO `id_test` (`email`, `password`, `date`) VALUES ('$email', '$hash', CURRENT_TIMESTAMP())";
...
<body>
    ...
    <div class="container my-4">
        ...
        <form action="/firoj/logein/signup.php" method="POST">
            <div class="mb-3">
